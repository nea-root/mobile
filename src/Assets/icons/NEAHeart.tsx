...
const NEAHeart:React.FC<IconProps> = ({  width = 20, height = 20, ...props })=>{
    return (    <Svg xmlns="http://www.w3.org/2000/svg" width={55} height={48} viewBox="0 0 55 48" fill="none">
    <Path
    ...
    />
    <Defs>
      <LinearGradient id="paint0_linear_625_6471" x1={20.7163} y1={0.0427593} x2={20.7163} y2={48.6563} gradientUnits="userSpaceOnUse">
        <Stop stopColor="#4AC16A" />
        <Stop offset={1} stopColor="#147952" />
      </LinearGradient>
      <LinearGradient id="paint1_linear_625_6471" x1={34.9718} y1={-0.00963292} x2={34.9718} y2={15.3528} gradientUnits="userSpaceOnUse">
        <Stop stopColor="#4AC16A" />
        <Stop offset={1} stopColor="#147952" />
      </LinearGradient>
      <LinearGradient id="paint2_linear_625_6471" x1={6.21511} y1={0.265393} x2={6.21511} y2={38.0131} gradientUnits="userSpaceOnUse">
        <Stop stopColor="#4AC16A" />
        <Stop offset={1} stopColor="#147952" />
      </LinearGradient>
      <LinearGradient id="paint3_linear_625_6471" x1={49.0368} y1={-0.00963292} x2={49.0368} y2={15.3528} gradientUnits="userSpaceOnUse">
        <Stop stopColor="#4AC16A" />
        <Stop offset={1} stopColor="#147952" />
      </LinearGradient>
      <LinearGradient id="paint4_linear_625_6471" x1={42.2166} y1={18.0613} x2={42.2166} y2={47.9824} gradientUnits="userSpaceOnUse">
        <Stop stopColor="#4AC16A" />
        <Stop offset={1} stopColor="#147952" />
      </LinearGradient>
    </Defs>
