...
export const cognitoErrorHandler = (error: CognitoError | any): string => {
  ...
  const errorMessages: Record<string, string> = {
    ...
    SoftwareTokenMFANotFoundException:
      'Software token MFA not enabled. Please contact support.',
    ...
    InvalidSmsRoleAccessPolicyException:
      'The SMS role trust relationship is invalid. Please contact support.',
    InvalidSmsRoleTrustRelationshipException:
      'The trust relationship for the SMS role is invalid. Please contact support.',
