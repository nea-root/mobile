    ...
    return (
      <Bubble
        ...
        bottomContainerStyle={{
          left: {backgroundColor: Colors.Palette.white},
          right: {backgroundColor: Colors.Palette.white},
        }}
        containerStyle={{
          left: {
            marginLeft: Variables?.MetricsSizes?.medium,
            marginVertical: Variables?.MetricsSizes?.medium,
          },
          right: {
            marginLeft: Variables?.MetricsSizes?.medium,
            marginVertical: Variables?.MetricsSizes?.medium,
        ...
        wrapperStyle={{
          left: {
            padding: Variables?.MetricsSizes?.extraSmall,
  ...
  return (
    <SafeAreaView style={styles.container}>
      <Text style={styles.infoText}>
        Your conversations are confidential, so feel free to express yourself
        openly.\nPLEASE NOTE: Our volunteers are not available to offer legal or
        professional advice.
      </Text>
      <GiftedChat
        messages={messages}
