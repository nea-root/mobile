import reducer, { changeTheme, setDefaultTheme, initialState, ThemeState } from '@/Store/Theme/index';
...
describe('ThemeSlice reducer', () => {
  ...
  describe('changeTheme', () => {
    ...
    it('changes both theme and darkMode', () => {
      const state = reducer(initialState, changeTheme({ theme: 'default', darkMode: true }));
      expect(state.theme).toBe('default');
      expect(state.darkMode).toBe(true);
    });
