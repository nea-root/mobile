...
describe('WalkthroughCarousel', () => {
  it('renders without crashing for victim flowType', () => {
    expect(() => render(<WalkthroughCarousel flowType="victim" />)).not.toThrow();
  });

  it('renders without crashing for volunteer flowType', () => {
    expect(() => render(<WalkthroughCarousel flowType="volunteer" />)).not.toThrow();
  });

  it('renders without crashing for lawyer flowType', () => {
    expect(() => render(<WalkthroughCarousel flowType="lawyer" />)).not.toThrow();
  });

  it('renders without crashing for therapist flowType', () => {
    expect(() => render(<WalkthroughCarousel flowType="therapist" />)).not.toThrow();
  });
  ...
  it('renders with onActiveIndexChange callback', () => {
    ...
    expect(() =>
      render(
        <WalkthroughCarousel flowType="victim" onActiveIndexChange={onActiveIndexChange} />
      )
    ).not.toThrow();
  });
