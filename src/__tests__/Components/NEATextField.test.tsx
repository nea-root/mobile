...
describe('NEATextField', () => {
  ...
  it('does not render required asterisk when required=false', () => {
    const { queryByText } = render(<NEATextField label="Email" required={false} />);
  ...
  it('calls onChangeText when text changes', () => {
    ...
    const { UNSAFE_getByType } = render(
      <NEATextField value="" onChangeText={onChangeText} placeholder="Enter email" />
    );
